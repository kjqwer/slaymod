...
{
    public const string ModId = "MySts2Mod";
...
文件放在 `MySts2Mod/localization/{lang}/` 目录下。文件名即表名(如 `relics.json` -> 表名 `"relics"`)。
...
- Mod ID: `MySts2Mod`，类名: `PuppyPowerRelic`
- 生成 ID: `MYSTS2MOD-PUPPY_POWER_RELIC`
- 本地化键: `MYSTS2MOD-PUPPY_POWER_RELIC.title` 等
...
```csharp
"file.png".RelicImagePath()       // -> MySts2Mod/images/relics/file.png
"file.png".BigRelicImagePath()    // -> MySts2Mod/images/relics/big/file.png
"file.png".CardImagePath()        // -> MySts2Mod/images/card_portraits/file.png
"file.png".BigCardImagePath()     // -> MySts2Mod/images/card_portraits/big/file.png
"file.png".PowerImagePath()       // -> MySts2Mod/images/powers/file.png
"file.png".BigPowerImagePath()    // -> MySts2Mod/images/powers/big/file.png
"file.png".CharacterUiPath()      // -> MySts2Mod/images/charui/file.png
"file.png".ImagePath()            // -> MySts2Mod/images/file.png
```
